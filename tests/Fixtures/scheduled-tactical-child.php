...
// it engaged refuses admission/claim and sends nothing, so a dark transport would look
// like a passing control. Refuse loudly on THIS verified connection instead.
