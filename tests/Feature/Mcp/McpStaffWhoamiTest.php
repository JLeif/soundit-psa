...
class McpStaffWhoamiTest extends TestCase
{
    ...
    public function test_whoami_returns_label_directive_and_allowed_tools_without_posture(): void
    {
        ...
        $this->assertSame(['whoami', 'list_tool_surface', 'search_tools', 'find_staff'], $payload['allowed_tools']);
    ...
    public function test_whoami_uses_non_colliding_legacy_label_for_labelless_token(): void
    {
        ...
        $this->assertSame(['whoami', 'list_tool_surface', 'search_tools', 'find_staff'], $scopedPayload['allowed_tools']);
